...
CONFIG_PATH = Path("configs/p3_backtest.yaml")
...
def load_config() -> dict[str, Any]:
    ...
    for index, value in enumerate(config["protected_p3_inputs"]):
        _assert_relative_path(str(value), f"protected_p3_inputs[{index}]")
    return config
